...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		try{
			shortList.add(null);
			fail("check for null elements");
		}
		catch(NullPointerException e){
			
		}
		assertEquals("Check if returns true",true, shortList.add("C"));
		assertEquals("Check for the element at index 2", "C", shortList.get(2));
		assertEquals("Check the size  of the shortList",3,shortList.size);
	...
	public void testAddAtIndex()
	{
		...
		try{
			shortList.add(2,"C");
			fail("check for the index bounds");
		}
		catch(IndexOutOfBoundsException e){
